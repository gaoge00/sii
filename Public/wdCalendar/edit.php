...
<body>
	<div class="mask">
		<div>This feature is disabled. Please download this plugin and install
			it in your machine for full features</div>
	</div>
	<div>
		<div class="toolBotton">
			<a id="Savebtn" class="imgbtn" href="javascript:void(0);"> <span
				class="Save" title="Save the calendar">Save(<u>S</u>)
			</span>
			</a>                           
        <?php if($event){ ?>
        <a id="Deletebtn" class="imgbtn" href="javascript:void(0);"> <span
				class="Delete" title="Cancel the calendar">Delete(<u>D</u>)
			</span>
			</a>             
        <?php } ?>            
        <a id="Closebtn" class="imgbtn" href="javascript:void(0);"> <span
				class="Close" title="Close the window">Close </span></a> </a>
		</div>
		<div style="clear: both"></div>
		<div class="infocontainer">
			<form
				action="php/datafeed.php?method=adddetails<?php echo $event?"&id=".$event->Id:""; ?>"
				...
				<label> <span> *Subject: </span>
					...
					value="<?php echo $event?$event->Subject:"" ?>" /> <input
					id="colorvalue" name="colorvalue" type="hidden"
					value="<?php echo $event?$event->Color:"" ?>" />
